        ...
        for (file in listFile) {
                if (file.isDirectory) {
                        ...
                        label.graphic = ImageView(
                                Image(
                                        "D:\\ytjava\\word-tree\\src\\main\\resources\\resources\\文件夹.png",
                                        15.0,
                                        15.0,
                                        true,
                                        true
                        ...
                        label.graphic = ImageView(
                                Image(
                                        "D:\\ytjava\\word-tree\\src\\main\\resources\\resources\\文件.png",
                                        15.0,
                                        15.0,
                                        true,
                                        true
                        ...
                        if (renameTo) {
                                if (com.wordtree.wt_kt_note_book.file != null) {
                                        ...
                                        fileItemRoot2.graphic =
                                                ImageView(Image(R.ImageUrl("FileSet"), 15.0, 15.0, true, true))
...
fun tab标签的切换与文本区光标的聚焦(tabPane: TabPane, codeAreaRequest: CodeArea, file: File) {
        ...
        tab.graphic = ImageView(Image(R.ImageUrl("FileIcon"), 15.0, 15.0, true, true))
...
fun 显示文本到编辑区(file: File, textArea: CodeArea) {
        ...
        if (cursorPosition.get(nowFile?.path) != null) {
                cursorPosition.get(nowFile?.path)
                        ?.let { position -> codeArea.moveTo(position as Int);codeArea.showParagraphInViewport(position as Int) }
        }
}
